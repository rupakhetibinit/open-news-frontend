		...
		<>
			<aside className='fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-700'>
				<div>
					<div className='-mx-6 px-6 py-4'>
						<a className='cursor-pointer' onClick={() => {}} title='home'>
							<svg
							...
							<a
								...
								<svg className='-ml-1 h-6 w-6' viewBox='0 0 24 24' fill='none'>
									<path
										...
										className='dark:fill-slate-600 fill-current text-cyan-400'></path>
									<path
			...
			<div className='ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]'>
				...
				<div className='px-6 pt-6 2xl:container'>
					<div className='flex flex-col h-[80vh] items-center justify-center rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600 overflow-y-auto pt-6'>
						{[
							...Array(10)
								.fill(1)
								.map((i, index) => <Post key={index} name={i} />),
						]}
					</div>
				</div>
			</div>
